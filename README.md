...
!WARNING!
You will not see any heros in the list because baseURL is in .env file. To see them you need to add this url 'https://sw-api.starnavi.io' to baseUrl variable in src/api/axios/index.ts
